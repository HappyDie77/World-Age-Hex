...
func start_night_tween():
	...
	tween.tween_property(world_environment.environment, "ambient_light_energy", 1.1, 2.0)
	...
	tween.tween_property(world_environment.environment, "volumetric_fog_density", 0.03, 3.0)
